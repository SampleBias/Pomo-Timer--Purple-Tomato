  ...
  theme: {
  	extend: {
  		...
  		backgroundImage: {
            ...
            'futuristic-gradient': 'radial-gradient(circle at top left, hsl(var(--accent-primary) / 0.1), transparent 40%), radial-gradient(circle at bottom right, hsl(var(--accent-secondary) / 0.1), transparent 40%)',
  		}
  	}
  },
